...
import { Lock, Zap, ShieldCheck, UserPlus, CheckCircle, AlertCircle, ArrowLeft, Eye, EyeOff } from 'lucide-react';
...
export const ActivateAccount: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!passwordValidation.isValid || !confirmMatch || !token || !email) {
      return;
    }

    setIsSubmitting(true);
    try {
      const result = await dispatch(activateAccount({ token, password, email })).unwrap();
      ...
      toast.error(err || 'Failed to activate account. Please try again.');
    } finally {
    ...
    <PageContainer>
      ...
      <RightPanel>
        ...
        <FormContainer>
          ...
          <Subtitle>
            Welcome! Set your password below to activate your account.
          </Subtitle>
